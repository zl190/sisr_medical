...
# Prepare data
train_dataset, train_count = datasets.get_coco_dataset('train', batch_size=config.bs, downsampling_factor=4, size=(config.in_h, config.in_w, 3))
validation_dataset, validation_count = datasets.get_coco_dataset('validation', batch_size=config.bs, downsampling_factor=4, size=(config.in_h, config.in_w, 3))
